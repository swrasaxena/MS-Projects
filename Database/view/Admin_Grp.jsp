...
<table id="alignment" border = "0" align="center">
		<tr> <td> <h2 align = "center"> Welcome, <%= session.getAttribute("username") %> </h2> </td></tr> 
		<tr> <td align = "center"><font size=5>Your groups are:</font></td>  </tr>
		...
		for (Object[] objs: obj1){ %>
		        <tr>
			<td align = "center"><a href = "GroupServlet?group_id=<%= objs[1]%>&group_name=<%= objs[0]%>"> <font size=3><%= objs[0]%> </font></a> </td>
		</tr>
		<%} %>
